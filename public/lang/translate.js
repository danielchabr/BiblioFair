	...
	'HOME': { 
		...
		'MODAL': {
			...
			'REQUEST_YOURSELF': 'There is no logic in requesting book from yourself',
	...
	'ACCOUNT': { 
		...
		'LONGITUDE': 'Longitude',
		'LATITUDE': 'Latitude',
		'SEARCH_LOC': 'Search by address',
		'SEARCH_LOC_TEXT': 'E.g. 96 Euston Road, London',
		'SEARCH' : 'Search',
		'NOT_FOUND' : 'We could not find this address, please try different one or set map manually',
...
//		'HEADING': 'Objevte ten nejlehčí způsob obchodování s knihami',
		...
		'PASSWORD': 'Heslo',
		'REMEMBER_ME': 'Zapamatovat na tomto počítači',
		'JOIN': 'Založit účet',
		'SIGNIN': 'Přihlásit',
		'SIGNIN_FACEBOOK': 'Přihlásit přes Facebook',
		'SIGNIN_GOOGLE': 'Přihlásit přes Google+',
        'REGISTER': 'Registrovat se',
		'REGISTER_ACTION': 'Přidejte se',
		'REGISTER_ACTION_SMALL': 'Přidejte se již dnes',
		'REGISTER_TEXT': 'Účet je zcela zdarma',
		...
		'REGISTRATION_REQUIRED': 'Registrujte se prosím pro možnost požádání o knihu'
	},
	'RECOVERY': {
	...
	'HOME': { 
		...
		'MODAL': {
			...
			'REQUEST_YOURSELF': 'Nedává smysl žádat sám sebe o knihu',
	...
	'ACCOUNT': { 
		...
		'SEARCH_LOC': 'Hledat podle adresy',
		'SEARCH_LOC_TEXT': 'Např. Mariánské náměstí 5, Praha',
		'SEARCH' : 'Hledat',
		'NOT_FOUND' : 'Nepodařilo se nám tuto adresu najít, prosím zkuste ji zadat v jiném tvaru nebo nastavte lokaci na mapě manuálně',
...
var languages = [['eng', 'English'], ['cze', 'Čeština'], ['slo', 'Slovenčina'], ['aar', 'Qafara'], ['abk', 'Аҧсуа'], ['ave', 'avesta'], ['afr', 'Afrikaans'], ['aka', 'akana'], ['amh', 'አማርኛ'], ['arg', 'aragonés'], ['ara', 'العربية'], ['asm', 'অসমীয়া'], ['ava', 'авар мацӀ; магӀарул мацӀ'], ['aym', 'aymar aru'], ['aze', 'Azərbaycanca'], ['bak', 'башҡорт теле'], ['bel', 'Беларуская мова'], ['bul', 'български език'],
