function libraryControl($rootScope, $scope, $http, $modal, $location, $filter, APIservice) {
	...
	$scope.languages = ['Qafara','Аҧсуа','avesta','Afrikaans','akana','አማርኛ','aragonés','العربية','অসমীয়া','авар мацӀ; магӀарул мацӀ','aymar aru','Azərbaycanca','башҡорт теле','Беларуская мова','български език','भोजपुरी','Bislama','bamanankan','বাংলা','བོད་ཡིག','brezhoneg','bosanski jezik','català; valencià','нохчийн мотт','Chamoru','corsu; lingua corsa','ᓀᐦᐃᔭᐍᐏᐣ','čeština','ѩзыкъ словѣньскъ','чӑваш чӗлхи','Cymraeg','dansk','Deutsch','ދިވެހިބަސ','རྫོང་ཁ','Ɛʋɛgbɛ','Ελληνικά','English','Esperanto','español; castellano','eesti keel','euskara','فارسی','Fulfulde; Pulaar; Pular','suomi; suomen kieli','vosa Vakaviti','føroyskt','français; langue française','frysk','Gaeilge','Gàidhlig','Galego','Avañe\'ẽ','ગુજરાતી','Gaelg; Manninagh','Hausancī; هَوُسَ','עִבְרִית; עברית','हिन्दी','Hiri Motu','hrvatski jezik','Kreyòl ayisyen','magyar','Հայերեն լեզու','Otjiherero','interlingua','Bahasa Indonesia','Interlingue','Igbo', 'Nuosu' ,'Iñupiaq; Iñupiatun','Ido','íslenska','italiano','ᐃᓄᒃᑎᑐᑦ','日本語','basa Jawa','ქართული ენა (kartuli ena)','Kikongo','Gĩkũyũ','kuanyama','Қазақ тілі','kalaallisut; kalaallit oqaasii','ភាសាខ្មែរ','ಕನ್ನಡ','한국어 (韓國語); 조선말 (朝鮮語)','kanuri','कॉशुर; کٲشُر','Kurdî; كوردي','коми кыв','Kernewek','кыргыз тили','latine; lingua Latina','Lëtzebuergesch','Luganda','Limburgs','lingala','ພາສາລາວ','lietuvių kalba', 'Luba-Katanga','latviešu valoda','Malagasy fiteny','Kajin M̧ajeļ','te reo Māori',
		'македонски јазик','മലയാളം','монгол хэл','मराठी','bahasa Melayu; بهاس ملايو','Malti','မြန်မာစာ','Ekakairũ Naoero','bokmål','isiNdebele','नेपाली','Owambo','Nederlands','nynorsk','norsk','isiNdebele','Diné bizaad; Dinékʼehǰí','chiCheŵa; chinyanja','Occitan','ᐊᓂᔑᓇᐯᒧᐏᐣ (Anishinaabemowin)','Afaan Oromoo','ଓଡ଼ିଆ','ирон ӕвзаг','ਪੰਜਾਬੀ; پنجابی','पालि','polski','پښتو','português','Runa Simi; Kichwa','rumantsch grischun','Rundi','română','русский язык','Ikinyarwanda','संस्कृतम्','sardu','سنڌي، سندھی; सिन्धी','sámi; sámegiella','yângâ tî sängö','සිංහල','slovenčina','slovenščina','gagana fa\'a Samoa','chiShona','Soomaaliga; af Soomaali','Shqip','српски језик; srpski jezik','siSwati','Sesotho','basa Sunda','svenska','Kiswahili','தமிழ்','тоҷикӣ; تاجیکی' , 'Tajik', 'ภาษาไทย','ትግርኛ','Түркмен','Wikang Tagalog','Setswana','faka-Tonga','Türkçe','Xitsonga','татарча; tatarça', 'Twi', 'te reo Tahiti; te reo Māʼohi','Uyƣurqə; Uyğurçe; ئۇيغۇرچ','українська мова','اردو','O\'zbek; Ўзбек; أۇزبېك','Tshivenḓa','Tiếng Việt','Volapük','walon','Wolof','isiXhosa','ייִדיש','Yorùbá','Saɯ cueŋƅ; Saw cuengh','漢語; 汉语; 中文','isiZulu'];

	$scope.abbr = ['aar','abk','ave','afr','aka','amh','arg','ara','asm','ava','aym','aze','bak','bel','bul','bih','bis','bam','ben','tib','bre','bos','cat','che','cha','cos','cre','cze','chu','chv','wel','dan','ger','div','dzo','ewe','gre','eng','epo','spa','est','baq','per','ful','fin','fij','fao','fre','fry','gle','gla','glg','grn','guj','glv','hau','heb','hin','hmo','hrv','hat','hun','arm','her','ina','ind','ile','ibo','iii','ipk','ido','ice','ita','iku','jpn','jav','geo','kon','kik','kua','kaz','kal','khm','kan','kor','kau','kas','kur','kom','cor','kir','lat','ltz','lug','lim','lin','lao','lit','lub','lav','mlg','mah','mao','mac','mal','mon','mar','may','mlt','bur','nau','nob','nde','nep','ndo','dut','nno','nor','nbl','nav','nya','oci','oji','orm','ori','oss','pan','pli','pol','pus','por','que','roh','run','rum','rus','kin','san','srd','snd','sme','sag','sin','slo','slv','smo','sna','som','alb','srp','ssw','sot','sun','swe','swa','tam','tel','tgk','tha','tir','tuk','tgl','tsn','ton','tur','tso','tat','twi','tah','uig','ukr','urd','uzb','ven','vie','vol','wln','wol','xho','yid','yor','zha','chi','zul']
}
